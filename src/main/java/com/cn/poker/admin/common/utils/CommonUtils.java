...
import com.cn.poker.admin.common.entity.SequenceNumber;
...
public class CommonUtils {
	 ...
	 * @return
	 */
	public static List addIndex(List list, int pageNo, int pageSize){
		for (int i = 0; i<list.size(); i++) {
			SequenceNumber sequenceNumber = (SequenceNumber) list.get(i);
			sequenceNumber.setIndex( (pageNo - 1)*pageSize + i+1+"");
		}
		return list;
	}
