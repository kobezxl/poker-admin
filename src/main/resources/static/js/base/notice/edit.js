...
var vm = new Vue({
	...
	methods : {
		...
		setForm: function() {
			$.SetForm({
		    	...
		    	success: function(data) {
                    ...
                    editor2.txt.html(data.enContent);
		    	}
			});
		},
		acceptClick: function() {
            ...
            text_content1=editor1.txt.html()
                .replace(/\</g,'&lt;')
                .replace(/\>/g,'&gt;')
            ...
            vm.tNotice.content=text_content1;

            text_content2=editor2.txt.html()
                .replace(/\</g,'&lt;')
                .replace(/\>/g,'&gt;')
                .replace(/x-small/g,'0.26666rem')//20
                .replace(/small/g,'0.32rem')//24
                ...
                .replace(/large/g,'0.42666rem')//32
                .replace(/text-decoration-line/g,'text-decoration'); // 解决删除线跟下划线，ios不支持
            vm.tNotice.enContent=text_content2;
		    $.ConfirmForm({
